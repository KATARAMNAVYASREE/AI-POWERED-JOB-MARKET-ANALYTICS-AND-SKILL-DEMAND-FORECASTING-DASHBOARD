...
* **Random Forest** → Pattern analysis & job role prediction
...
The dataset used in this project consists of structured job postings data collected from publicly available sources such as Kaggle and GitHub.
...
Used for predicting future skill demand trends.

## 2. Random Forest

Used for pattern analysis and job role prediction.
...
* Helps students identify in-demand skills
...
1. Tzimas et al., *Transforming Online Job Postings into Labor-Market Intelligence*, MDPI, 2024
2. Weichselbraun, *Anticipating Job Market Demands*, MDPI, 2024
3. Mahmud et al., *AI-Powered Workforce Analytics*, 2024
4. Fettacha et al., *Skill Demand Forecasting*, 2025
